...
# labels contain the assignment of each data point the cluster

# iteratae over each cluster index, and put the data point assignment to each cluster in points[]
for i in range(k):
    points = []
    ...
    # update the position of that centroid to the true center, to get the new centroid
    if len(points) > 0:  
